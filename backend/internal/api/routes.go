...
func loadRoutes() *chi.Mux {
	...
	router.Get("/ecosystem/batches", ListEcosystemBatchesHandler)
	router.Get("/ecosystem/batches/{batchId}", GetEcosystemBatchHandler)
	router.Get("/ecosystem/batches/{batchId}/summary", GetEcosystemBatchSummaryHandler)
	router.Get("/ecosystem/batches/{batchId}/repos", ListEcosystemBatchReposHandler)
